...
def main():
    ...
    if args.dataset == "svhn":
        ...
        print('Forget loader length:', len(forget_loader))
        ...
        print('Retain loader length:', len(retain_loader))
    ...
    if args.resume:
        checkpoint = unlearn.load_unlearn_checkpoint(model=model, device=device, args=args)
    ...
    if args.resume and checkpoint is not None:
        ...
        if args.unlearn != "retrain" and args.unlearn != "retrain_sam" and args.unlear != "retrain_ls":
